...
<template>
  ...
  <div class="row">
    <!-- 卡片一 -->
    <Al-Card img-src="/web.png" summary="前端主流布局系统进阶与实战，轻松解决页面布局难题" />
    <!-- 卡片二 -->
    <Al-Card img-src="go.png" summary="Google资深工程师深度讲解Go语言 由浅入深掌握Go语言">
      <!-- 插槽内部的内容样式由用户自己决定 -->
      <template #footer>
        <div class="footer">
  ...
  <div class="row">
    <Al-Card img-src="java.png" :width="368" :img-height="90">
